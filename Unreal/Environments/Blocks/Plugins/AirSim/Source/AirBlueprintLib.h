...
public:
    ...
    static void LogMessageString2(const char* prefix, const char* suffix, LogDebugLevel level, float persist_sec = 60);
    ...
    static void ListActors(const UObject* context, std::set<std::string>& results);
