...
PawnSimApi::ImageCaptureBase::ImageResponse PawnSimApi::getImageAsResponse(const std::string& camera_name, ImageCaptureBase::ImageType image_type) const
{
    ...
    if (response.size() > 0)
        ...
        return PawnSimApi::ImageCaptureBase::ImageResponse();
}
