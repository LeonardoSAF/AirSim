...
public:
    ...
    virtual void printLogMessage(const std::string& message, const std::string message_param = "", unsigned char severity = 0, float persist_sec = 2) override;
    ...
    virtual const std::set<std::string>& listSceneAllObjects() const override;
    ...
    virtual std::shared_ptr<msr::airlib::MultirotorBase> getMultirotorVehicleApi(const std::string& vehicleName) const override;
